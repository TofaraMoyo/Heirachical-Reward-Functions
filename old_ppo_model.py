...
Original file is located at
    https://colab.research.google.com/drive/12HTdeHKmW1tPaqMSlCklLPIieJzWrKyp
"""
        ...
        while total_steps < opt.Max_train_steps:
            ...
            while not done:
                ...
                if total_steps % opt.eval_interval == 0:
                    score = evaluate_policy(eval_env, agent, opt.max_action, turns=10) # evaluate the policy for 3 times, and get averaged result
